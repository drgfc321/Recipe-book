...
public class MainLayout extends AppLayout implements BeforeEnterObserver {
    ...
    private void createHeader() {
        H1 logo = new H1("D&D Campaign Manager");
        logo.getStyle()
    ...
    private void createDrawer() {
        ...
        nav.addItem(new SideNavItem("Campaigns", CampaignsView.class, VaadinIcon.BOOK.create()));
        nav.addItem(new SideNavItem("Characters", CharactersView.class, VaadinIcon.USER.create()));
        nav.addItem(new SideNavItem("Dice Roller", DiceRollerView.class, VaadinIcon.CUBE.create()));
